...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Gerenciamento de Loja Virtual">
        ...
        <div class="mobile-menu md:hidden">
            <div class="mobile-menu-bar">
                <a href="" class="flex mr-auto">
                    <img alt="Area Administrativa" style="width: 200px;" src="imgs/logo.png">
                </a>
            ...
            <ul class="border-t border-theme-24 py-5 hidden">
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu__title"> Cadastros <i data-feather="chevron-down" class="menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu__title"> Pedidos <i data-feather="chevron-down" class="menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                <a href="" class="intro-x flex items-center pl-5 pt-4">
                    <img alt="Area Administrativa" style="width: 300px;" src="imgs/logo.png">
                   
                </a>
                <div class="side-nav__devider my-6"></div>
                <ul>
                    <li>
                        <a href="?pg=Home" class="side-menu">
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu side-menu--active">
                            ...
                            <div class="side-menu__title"> Cadastros <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu">
                            ...
                            <div class="side-menu__title"> Usuários <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu">
                            ...
                            <div class="side-menu__title"> Pedidos <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                        ...
                        <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
                            <div class="dropdown-box__content box bg-theme-38 text-white">
                                ...
                                <div class="p-2 border-t border-theme-40">
                                    <a href="sair.php" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                                </div>
                            </div>
                        </div>
                    </div>
