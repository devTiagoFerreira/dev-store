<table class="table table-report -mt-2">
	  ...
	  $categoria = mysqli_query($conexao,"select * from tb_categorias order by id");
	 ...
	 $(".btnExcluir").click(function(e) {
		 ...
		 var 
		   ...
		   if (confirm('Tem certeza que deseja apagar esta categoria?') ){
			 ...
			 $.post("categorias/excluir.php",{id:id}, function(resultado){
			    alert(resultado);  
	...
	$(".btnAlterar").click(function(e) {  
	  e.preventDefault();
		 var 
		   ...
		   $.getJSON("categorias/alterar.php?id="+id, function(resultado){
			  $("#modo").val(1);
